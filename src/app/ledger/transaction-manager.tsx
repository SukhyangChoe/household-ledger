...
function CreateTransactionForm(
  ...
  return (
    <>
      <details
        ref={detailsRef}
        className="rounded-2xl border border-[var(--border)] bg-gray-50"
      >
        ...
        <div className="min-w-0">
          ...
          "income" ? (
            <p className="mt-1 text-xs text-gray-500">
              생활비{" "}
              {formatRate(
                transaction.applied_living_rate_bps ??
                  0,
              )}
              · 배정액{" "}
              {won(
